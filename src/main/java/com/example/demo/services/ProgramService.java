...
public class ProgramService {
  ...
  public int createRating(Rating rating, Long id) {
    ...
    if (program.isPresent()) {
      ...
      rating2.setId(Double.valueOf(ratingRepository.findAll().size()).longValue());
...
System.out.println(rating.getId());
        System.out.println(rating2.getId());

      listRatings.forEach(otro -> {
        System.out.println(rating.getId());
        System.out.println("asdasdadsdasdasasdasddsa");
        System.out.println(otro.getName());
        System.out.println(otro.getId());
        System.out.println(otro.getScore());
      });
      ...
      programRepository.save(program.get()).getRatings().forEach(otro -> {
        System.out.println(otro.getName());
        System.out.println(otro.getId());
        System.out.println(otro.getScore());
      });
